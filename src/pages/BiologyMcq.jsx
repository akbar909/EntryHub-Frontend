  ...
  return (
    ...
    >
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-zinc-900">
        <div className="max-w-md w-full p-6 space-y-6 bg-white dark:bg-zinc-800 dark:text-gray-300 shadow-md rounded-md">
          {error && <div className="alert alert-danger">{error}</div>}
          {isLoading && <p className="text-center">Loading questions...</p>}

          {!isLoading && questions.length > 0 && (
            <>
              <h2 className="text-2xl font-semibold text-center">Biology MCQs</h2>
