...
const ManageBiologyMcq = () => {
    ...
    const handleUpdateClick = async () => {
        try {
            const response = await axios.put(`https://entry-hub-backend.vercel.app/biologyquestions/update/${selectedQuestionId}`, {
    ...
    const addNewQuestion = async () => {
        try {
            const response = await axios.post('https://entry-hub-backend.vercel.app/biologyquestions/create', {
                questionText: newQuestion,
                options: newOptions,
                correctOption: correctOption - 1,
            });
    ...
    const deleteQuestion = async (questionId) => {
        try {
            const response = await axios.delete(`https://entry-hub-backend.vercel.app/biologyquestions/${questionId}`);
    ...
    return (
        <div className="container  items-center justify-center mx-auto my-8 p-8 bg-white shadow-lg rounded-lg">
            <h2 className="text-3xl font-semibold mb-4">Biology Admin Panel - Manage MCQs</h2>
...
export default ManageBiologyMcq;
